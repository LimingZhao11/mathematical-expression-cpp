//
// Created by Liming on 2023/4/26.
//
 ...
 */
static NumberCalculation getInstance(Mathematical_Expression calculation) {
 ...
 */
static boolean register_function(Function function) {
 ...
 */
static boolean unregister_function(String functionName) {
 ...
 * If true is returned, the function logout operation is successful!!!
 */
static boolean unregister_function(Function function) {
 ...
 */
static NumberCalculation getInstance(Mathematical_Expression calculation, String calculationName) {
    switch (calculation) {
